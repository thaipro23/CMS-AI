...
checks={
 ...
 'page_title_owned_by_topbar':'<h1>{pageChrome?.title || pageLabel(pathname)}</h1>' in app_shell and 'enterprise-page-header-copy' not in page_header and 'enterprise-page-description' not in page_header,
