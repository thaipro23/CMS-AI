...
EXPECTED_VERSION=25.9.16.7.2.64.16.5.1 \
RUN_NPM_CI=1 \
...
Review target: AI Server / Open edX CMS v25.9.16.7.2.64.16.5.1 — App Shell & Enterprise UI Rebuild + Production UI Hardening.
