...
from app.models import course, question, cost, job, generation_cache, token_calibration, generation_batch, audit, publish, concept, question_bank, rbac, academic, learning_analytics, identity  # noqa: F401 - import models for metadata
