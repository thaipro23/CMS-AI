...
def test_platform_pages_exist_and_legacy_routes_default_to_cms():
    ...
    for path, component in [
        ('frontend/app/student-management/cms/page.tsx', 'platform="cms"'),
        ('frontend/app/student-management/udemy/page.tsx', 'platform="udemy"'),
        ('frontend/app/teacher-management/cms/page.tsx', 'platform="cms"'),
        ('frontend/app/teacher-management/udemy/page.tsx', 'platform="udemy"'),
    ]:
        assert component in read(path)
