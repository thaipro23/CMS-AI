...
class AcademicService:
    ...
    def refresh_training_teacher_learning_data(self, user: UserContext, *, term_id: str, branch: str | None = None, campus: str | None = None, learning_platform: str | None = 'cms', class_id: str | None = None, strict: bool = True, progress_callback: Any | None = None, max_snapshot_age_seconds: int = 0) -> dict[str, Any]:
        return self._training_teacher_report_workflow().refresh_training_teacher_learning_data(user, term_id=term_id, branch=branch, campus=campus, learning_platform=learning_platform, class_id=class_id, strict=strict, progress_callback=progress_callback, max_snapshot_age_seconds=max_snapshot_age_seconds)
