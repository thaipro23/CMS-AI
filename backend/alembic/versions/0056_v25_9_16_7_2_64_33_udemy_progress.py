...
def downgrade() -> None:
    for name in [
        'ix_udemy_progress_unmatched_delivery_email', 'ix_udemy_progress_unmatched_batch_reason',
        'ix_udemy_progress_unmatched_rows_created_at', 'ix_udemy_progress_unmatched_rows_reason_code',
        'ix_udemy_progress_unmatched_rows_email', 'ix_udemy_progress_unmatched_rows_subject_delivery_id',
        'ix_udemy_progress_unmatched_rows_batch_id',
    ]:
        op.drop_index(name, table_name='udemy_progress_unmatched_rows')
    op.drop_table('udemy_progress_unmatched_rows')
    for name in [
        'ix_udemy_student_progress_class_student', 'ix_udemy_student_progress_delivery_match',
        'ix_udemy_student_progress_delivery_late', 'ix_udemy_student_progress_last_imported_at',
        'ix_udemy_student_progress_last_import_batch_id', 'ix_udemy_student_progress_source_format',
        'ix_udemy_student_progress_match_status', 'ix_udemy_student_progress_is_late',
        'ix_udemy_student_progress_normalized_email', 'ix_udemy_student_progress_student_id',
        'ix_udemy_student_progress_class_id', 'ix_udemy_student_progress_subject_delivery_id',
    ]:
        op.drop_index(name, table_name='udemy_student_progress')
    op.drop_table('udemy_student_progress')
    for name in [
        'ix_udemy_progress_batch_delivery_hash', 'ix_udemy_progress_batch_job_status',
        'ix_udemy_progress_batch_delivery_created', 'ix_udemy_progress_import_batches_created_at',
        'ix_udemy_progress_import_batches_finished_at', 'ix_udemy_progress_import_batches_requested_by',
        'ix_udemy_progress_import_batches_status', 'ix_udemy_progress_import_batches_parser_format',
        'ix_udemy_progress_import_batches_file_hash', 'ix_udemy_progress_import_batches_idempotency_key',
        'ix_udemy_progress_import_batches_duplicate_of_batch_id',
        'ix_udemy_progress_import_batches_subject_delivery_id',
        'ix_udemy_progress_import_batches_parent_job_id',
    ]:
        op.drop_index(name, table_name='udemy_progress_import_batches')
    op.drop_table('udemy_progress_import_batches')
