...
def downgrade() -> None:
    op.drop_index('ix_academic_subject_delivery_platform_scope', table_name='academic_subject_deliveries')
    op.drop_index('ix_academic_subject_delivery_scope_active', table_name='academic_subject_deliveries')
    for name in [
        'ix_academic_subject_deliveries_catalog_refreshed_at',
        'ix_academic_subject_deliveries_configured_at',
        'ix_academic_subject_deliveries_configured_by',
        'ix_academic_subject_deliveries_configuration_source',
        'ix_academic_subject_deliveries_active',
        'ix_academic_subject_deliveries_learning_platform',
        'ix_academic_subject_deliveries_branch',
        'ix_academic_subject_deliveries_block_id',
        'ix_academic_subject_deliveries_term_id',
        'ix_academic_subject_deliveries_subject_id',
    ]:
        op.drop_index(name, table_name='academic_subject_deliveries')
    op.drop_table('academic_subject_deliveries')
