...
def downgrade() -> None:
    op.drop_index('ix_udemy_plan_milestone_plan_order', table_name='udemy_subject_plan_milestones')
    op.drop_index('ix_udemy_subject_plan_milestones_deadline_date', table_name='udemy_subject_plan_milestones')
    op.drop_index('ix_udemy_subject_plan_milestones_plan_id', table_name='udemy_subject_plan_milestones')
    op.drop_table('udemy_subject_plan_milestones')
    for name in [
        'ix_udemy_subject_plan_delivery_imported',
        'ix_udemy_subject_plan_delivery_active',
        'ix_udemy_subject_plans_imported_at',
        'ix_udemy_subject_plans_imported_by',
        'ix_udemy_subject_plans_source_file_hash',
        'ix_udemy_subject_plans_source',
        'ix_udemy_subject_plans_active',
        'ix_udemy_subject_plans_subject_delivery_id',
    ]:
        op.drop_index(name, table_name='udemy_subject_plans')
    op.drop_table('udemy_subject_plans')
