...
def upgrade() -> None:
    ...
    op.create_index('ix_ai_bank_chapter_stats_subject', 'ai_bank_chapter_stats', ['subject_id'])
    op.create_index('ix_ai_bank_chapter_stats_offering', 'ai_bank_chapter_stats', ['subject_offering_id'])
    op.create_index('ix_ai_bank_chapter_stats_latest_bank', 'ai_bank_chapter_stats', ['latest_bank_version_id'])
    op.create_index('ix_ai_bank_chapter_stats_ready', 'ai_bank_chapter_stats', ['ready_to_release'])
    op.create_index('ix_ai_bank_chapter_stats_updated', 'ai_bank_chapter_stats', ['updated_at'])
    op.create_index('ix_ai_bank_chapter_stats_subject_unresolved', 'ai_bank_chapter_stats', ['subject_id', 'unresolved_count'])
    op.create_index('ix_ai_bank_chapter_stats_offering_ready', 'ai_bank_chapter_stats', ['subject_offering_id', 'ready_to_release'])
