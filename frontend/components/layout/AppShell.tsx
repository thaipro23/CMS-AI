...
const navItems: NavItem[] = [
  ...
  { href: '/ap-sync', label: 'Đồng bộ AP', icon: 'sync', group: 'operations', permission: 'academic.catalog.manage' },
  { href: '/ops/readiness', label: 'Kiểm tra vận hành', icon: 'readiness', group: 'operations', permission: 'view_ops_readiness', diagnostic: true },
  { href: '/premises', label: 'Cơ sở', icon: 'campus', group: 'catalog', permission: 'academic.catalog.manage' },
  { href: '/semesters', label: 'Học kỳ', icon: 'semester', group: 'catalog', permission: 'academic.catalog.manage' },
  { href: '/subject-management', label: 'Quản lý môn học', icon: 'book', group: 'catalog', permission: 'academic.catalog.manage' },
...
function requiredPermissionForPath(pathname: string): string | null {
  const rules: Array<[RegExp, string]> = [
    ...
    [/^\/premises(?:\/|$)/, 'academic.catalog.manage'],
    [/^\/semesters(?:\/|$)/, 'academic.catalog.manage'],
    [/^\/subject-management(?:\/|$)/, 'academic.catalog.manage'],
    [/^\/ap-sync(?:\/|$)/, 'academic.catalog.manage'],
