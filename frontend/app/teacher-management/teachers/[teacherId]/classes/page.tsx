...
export default function TeacherClassesPage() {
  ...
  const columns = useMemo<EnterpriseTableColumn<AcademicTrainingClassReport>[]>(() => [
    ...
    { key: 'actions', header: 'Thao tác', kind: 'actions', width: 132, sticky: 'right', hideable: false, render: (cls) => <div className="training-row-actions"><Link className="btn small primary" href={classDetailHref(cls, teacher, filters)}>Chi tiết</Link><Link className="btn small secondary" href={learningBehaviorHref(cls, filters)}>Phân tích</Link></div> },
