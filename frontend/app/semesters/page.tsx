...
export default function SemestersPage() {
  ...
  return <PageRoot className="page-stack enterprise-standard-page training-operations-page semesters-page">
    ...
    <AccessibleDialog
      open={modalOpen}
      title={form.id ? `Sửa học kỳ ${form.term_code}` : 'Thêm học kỳ'}
      description="Cấu hình đúng hai block và sáu tuần học cho mỗi block."
    ...
    <AccessibleDialog
      ...
      title={`Xóa học kỳ ${deleteTarget?.term_name || ''}?`}
      description="Học kỳ và kế hoạch tuần học sẽ chuyển sang trạng thái đã xóa; dữ liệu lớp và sinh viên lịch sử được giữ nguyên."
