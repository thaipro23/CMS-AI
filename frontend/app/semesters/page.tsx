...
function toDateInput(value?: string | null) { return normalizeVNDateInput(value) }
...
function addDays(value: string, days: number) { return addDaysToVNDateInput(value, days) }
...
export default function SemestersPage() {
  ...
  const save = async () => {
    ...
    if (invalidDateBlock) { setMessage('Ngày block/tuần học phải nhập theo định dạng dd/mm/yyyy, ví dụ 11/05/2026'); return }
    setSaving(true); setMessage('')
    try {
