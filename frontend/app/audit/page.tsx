...
const actionLabel: Record<string, string> = {
  ...
  'academic.class_sync.async.retry': 'Đồng bộ lớp/CMS · đã lên lịch chạy lại',
  'academic.progress_email.enqueue': 'Xếp hàng gửi nhắc tiến độ',
  'academic.progress_email.completed': 'Gửi nhắc tiến độ',
  'academic.progress_email.failed': 'Gửi nhắc tiến độ',
  'academic.sync_all_student_scores': 'Đồng bộ điểm CMS tự động 05:00',
  'academic.subject_course_mapping.auto_all_sync_job.enqueue': 'Tự động ghép Course CMS · xếp hàng',
  'academic.subject_course_mapping.auto_all_sync_job.finish': 'Tự động ghép Course CMS · hoàn tất',
  'academic.subject_course_mapping.auto_all_sync_job.failed': 'Tự động ghép Course CMS · thất bại',
