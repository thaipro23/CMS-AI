...
Bản này tiếp tục từ `.64.2`, không có migration mới. Mục tiêu là tách workflow Release/Publish/Rollback/Audit của Question Bank ra khỏi `question_bank_service.py` nhưng giữ nguyên behavior runtime.
